    ...
    <section className="bg-[#0f172a] w-full flex items-center justify-center">
      <div className="my-20 max-w-7xl px-12 ">
        <div className="flex items-center justify-between gap-20">
          <h1 className="uppercase text-4xl md:text-6xl font-semibold font-oswald text-white">
        ...
        <div className="flex items-center justify-center flex-wrap gap-8 mt-18">
          ...
          <div className="bg-gray-900 border border-white w-68 px-8 py-12 rounded-2xl text-center space-y-6">
            <h1 className="text-6xl text-white font-semibold font-oswald">
              768{" "}
              <span className="text-4xl align-super text-yellow-300">K</span>
            </h1>
          ...
          <div className="bg-gray-900 border border-white text-white  w-68 px-8 py-12 rounded-2xl text-center space-y-6">
            <h1 className="text-6xl font-semibold font-oswald">
